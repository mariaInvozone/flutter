...
class ProductsList extends StatefulWidget {
  ...
  @override
  State<ProductsList> createState() => _ChooseLocationState();
}

class _ChooseLocationState extends State<ProductsList> {
                          ...
                          children: List.generate(choices.length, (index) {
                            return  InkWell(
                                onTap: (){
                                  ...
                                  Get.to(AllProducts(), arguments: "${choices[index].title}");
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: (){
                          ...
                          Get.to(AllProducts(),  arguments: 'All Products');
